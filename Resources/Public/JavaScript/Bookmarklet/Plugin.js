...
var _Bookmarklet = __webpack_require__(7);

var _Bookmarklet2 = _interopRequireDefault(_Bookmarklet);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('Psmb.Bookmarklet:Bookmarklet', {}, function (globalRegistry) {
    var containerRegistry = globalRegistry.get('containers');
    containerRegistry.set('PrimaryToolbar/Right/Bookmarklet', _Bookmarklet2.default, 'before PrimaryToolbar/Right/UserDropDown');
});
...
var Bookmarklet = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
        i18nRegistry: globalRegistry.get('i18n')
    };
}), _dec2 = (0, _reactRedux.connect)((0, _plowJs.$transform)({
    workspaceName: (0, _plowJs.$get)('cr.workspaces.personalWorkspace.name')
})), _dec(_class = _dec2(_class = (_temp = _class2 = function (_Component) {
    _inherits(Bookmarklet, _Component);

    function Bookmarklet() {
        _classCallCheck(this, Bookmarklet);

        return _possibleConstructorReturn(this, (Bookmarklet.__proto__ || Object.getPrototypeOf(Bookmarklet)).apply(this, arguments));
    }

    _createClass(Bookmarklet, [{
        key: 'render',
        value: function render() {
            var link = 'javascript:(function()%7Bwindow.location %3D \'%2Fneos!%3Fnode%3D\' %2B document.querySelector(\'%5Bdata-neos-node%5D\').dataset.neosNode.replace(\'%40live\'%2C \'%40' + this.props.workspaceName + '\')%7D)()';
            return _react2.default.createElement(
                'div',
                { style: { display: 'inline-block', marginTop: '9px' } },
                _react2.default.createElement(
                    'a',
                    { href: link, title: 'Neos' },
                    _react2.default.createElement(_reactUiComponents.Icon, { icon: 'neos', size: '1x' }),
                    _react2.default.createElement(
                        'span',
                        { style: { display: 'none' } },
                        'Neos'
